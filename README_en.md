...
2. Open the [configurator](https://amneziamikrotikwg.github.io/awg-proxy/configurator.html)
...
Download `awg-proxy-{arch}.tar.gz` from [Releases](https://github.com/amneziamikrotikwg/awg-proxy/releases/latest) and upload it to the router via Winbox or SCP. For RouterOS 7.20 and below, use files with the `-7.20-Docker` suffix (Docker format).
